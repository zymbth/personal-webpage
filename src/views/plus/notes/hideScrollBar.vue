<!-- 主页 -->
<template>
  <div class="note-hide-scrollbar">
  	<h3>隐藏滚动条</h3>
  	<h5>通过套上一层容器实现</h5>
  	<ul>
  		<li>内层高度与外层一致</li>
  		<li>内层绝对定位，宽度比外层长17px(一个滚动条宽度)</li>
  		<li>外层overflow=hidden</li>
  		<li>内层保持垂直滚动条(overflow-x=hidden;overflow-y=scroll)</li>
  		<li>具体样式F12自行查看</li>
  	</ul>
		<div class="wrapper">
			<div class="inner-div">
				<p v-for="i in 6">{{demoText}}</p>
			</div>
		</div>
		
		<h5>全局更改滚动条样式</h5>
		<markdown-preview :initialValue='codeStr' />
  </div>
</template>
